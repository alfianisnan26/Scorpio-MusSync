 ...
 * This program sends a Datagram client request packet to a Network time
...
public final class NTPClient {
     ...
     */
    private static long processResponse(final TimeInfo info) {
